...
#[tokio::test]
async fn test_foo_page_returns_200() {
    ...
    let response = client
        .get(format!("{server_url}/page/v1/foo"))
        .send()
        .await
...
#[tokio::test]
async fn test_foo_page_renders_correct_inertia_component() {
    let app = TestAppBuilder::new()
        .clear_tables()
        .build()
        .await
    ...
    assert_eq!(body["component"], "Foo/Index");
...
#[tokio::test]
async fn test_foo_page_has_correct_props() {
    let app = TestAppBuilder::new()
        .clear_tables()
        .build()
        .await
...
#[tokio::test]
async fn test_foo_page_without_inertia_header() {
    let app = TestAppBuilder::new()
        .clear_tables()
        .build()
        .await
